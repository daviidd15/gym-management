...
/**
 * La clase PanelCreacionSesionActividadGrupal extiende de JPanel y es utilizada para mostrar
 * la vista de creacion de una sesion de una actividad grupal
 * 
 * @author Alvaro Casasus, David Palomares, Laura de la Cruz
 *
 */
public class PanelCreacionSesionActividadGrupal extends JPanel{
	private JComboBox actividadCombo;
	...
	/**
	 * Constructor de la clase PanelCreacionSesionActividadGrupal
	 * 
	 * inicializa los componentes de la vista
	 */
	public PanelCreacionSesionActividadGrupal() {
		...
		JLabel nombrePanel = new JLabel("Creación Sesion Actividad Grupal");
		...
		String ejActividades[]= {"No hay actividades disponibles"};
		JLabel actividad = new JLabel("Tipo de actividad: ");
		actividadCombo = new JComboBox(ejActividades);
		...
		layout.putConstraint(SpringLayout.NORTH, dia, 200, SpringLayout.NORTH, this);
		...
		layout.putConstraint(SpringLayout.WEST, actividad, 0, SpringLayout.WEST, sala);
		layout.putConstraint(SpringLayout.NORTH, actividad, 35, SpringLayout.NORTH, sala);
		
		layout.putConstraint(SpringLayout.NORTH, diaCombo, 200, SpringLayout.NORTH, this);
		...
		layout.putConstraint(SpringLayout.NORTH, salaCombo, 27, SpringLayout.NORTH, horaFinCombo);
		
		layout.putConstraint(SpringLayout.WEST, actividadCombo, 0, SpringLayout.WEST, salaCombo);
		layout.putConstraint(SpringLayout.NORTH, actividadCombo, 25, SpringLayout.NORTH, salaCombo);
		...
		layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, crear, 0, SpringLayout.HORIZONTAL_CENTER, nombrePanel);
		layout.putConstraint(SpringLayout.NORTH, crear, 50, SpringLayout.NORTH, actividadCombo);
		...
		this.add(salaCombo);
		this.add(actividadCombo);
		this.add(back);
		this.add(crear);
	}
	
	/**
	 * Setter que establece la lista de actividades grupales 
	 * 
	 * @param actividades lista de actividades grupales actualizada
	 */
	public void setActividades(List<ActividadGrupal> actividades) {

		if(actividades.size()==0){
			return;
		}
		this.remove(actividadCombo);
		this.actividadCombo.removeAllItems();
		
		for(ActividadGrupal a: actividades){
			actividadCombo.addItem(a.getNombre());
		}
		
		layout.putConstraint(SpringLayout.WEST, actividadCombo, 0, SpringLayout.WEST, this.salaCombo);
		layout.putConstraint(SpringLayout.NORTH, actividadCombo, 25, SpringLayout.SOUTH, this.salaCombo);
	 ...
	 */
	public void setControlBackCrearSesionActividades(ControlBackCrearSesionActividades control) {
	 ...
	 */
	public void setControlCrearSesionActividad(ControlCrearSesionActividad control){
	 ...
	 * Getter
	 * 
	 * @return String con la actividad de la que sera la sesion
	 */
	public String getActividad(){
		return this.actividadCombo.getSelectedItem().toString();
	}
}
