...
/**
 * Controlador que lleva al administrador desde la vista de cambiar el precio de una tarifa 
 *  a la pantalla principal del administrador
 * 
 * @author Alvaro Casasus, David Palomares, Laura de la Cruz
 *
 */
public class ControlBackPrecioTarifas implements ActionListener {
	 ...
	 */
	public ControlBackPrecioTarifas(VentanaProyecto frame) {
		this.frame = frame;
